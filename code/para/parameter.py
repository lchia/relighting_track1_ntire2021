...
class Parameter:
    ...
    def extract_args(self):
        ...
        self.parser.add_argument('--cpu', action='store_true', help='using cpu')
        ...
        # log
        self.parser.add_argument('--log_tag', type=str, default='relighting', help='the tag of the log of each training setting')
        ...
        self.parser.add_argument('--n_colors', type=int, default=3, help='input # of channels for input')
        self.parser.add_argument('--n_features', type=int, default=16, help='base # of channels for Conv')
        self.parser.add_argument('--n_features_level_1', type=int, default=4, help='base # of channels for Conv in level 1 of pynet2')
        ...
        self.parser.add_argument('--pynet_level', type=int, default=0, help='input # of channels for input')
        self.parser.add_argument('--with_in', action='store_true', help='model # with instance normalization for pynet')
        ...
        # training parameters
        self.parser.add_argument('--stage', type=int, default=1, help='stages of the model')
        ...
        self.parser.add_argument('--current_epoch', type=int, default=1, help='current epoch number')
        ...
        self.parser.add_argument('--no_html', action='store_true', 
                                 help='do not save intermediate training results to [opt.save_dir]/${TIME_DIR}/web/')
        self.parser.add_argument('--display_winsize', type=int, default=512,  help='display window size')
        self.parser.add_argument('--save_dense', action='store_true', 
                                 help='if specified, save ckpts of each epoch, or just save the latest and the best (by loss)')
        self.parser.add_argument('--GT', type=str, default='target',help='ground trueth: target or hdr')
        self.parser.add_argument('--loss_supervised', type=str, default='E2E',
                                 help='loss: supervised using target end-to-end (E2E) or using target-input (diff) or both (diffE2E)')
